...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('subject', models.CharField(max_length=200, verbose_name='Текст')),
                ('description', models.TextField(verbose_name='Объявления')),
                ...
                ('filter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='callboard.filteradvert', verbose_name='Фильтр')),
                ('image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gallery.gallery', verbose_name='Изоброжения')),
